 ...
 */
package calcolatricev2santuccimaicol;
import calcolatricev2santuccimaicol.OperazioneResponseV2;
import calcolatricev2santuccimaicol.CalcolatriceServiceV2;
...
public class GetHandlerV2 implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            // Parsing dei valori
            double operando1 = Double.parseDouble(parametri.get( "operando1").toString());
            double operando2 = Double.parseDouble(parametri.get("operando2").toString());
            String operatore = parametri.get("operatore").toString();
